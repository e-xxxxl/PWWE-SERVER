...
// Async hook: return a promise and let it reject on error. Do NOT reference
// `next` here — Mongoose 9 passes the save options as the first arg, not a
// callback, so calling it throws and masks the real error.
